...
class CelebA_VTAB(My_Dataset):
    def __init__(
        ...
        logger_handle.info(
            f"Entering function : CelebA_VTAB.__init__("
            f"in_root = {in_root}, "
            f"in_split = {in_split}, "
        ...
        try:
            ...
            logger_handle.info("WARNING : CelebA : Known bug, cannot read file {split_path}, likely a test file.")
        
        if self._m_split == "test":
            split_id = 2
